                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        ...
                        <c:if test="${billingAddress != null }">
                            <small><cite>Street: ${billingAddress.getStreet() }<br>City: ${billingAddress.getCity() }<br>Postal
                                Code: ${billingAddress.getPostalCode() }<br>Country: ${billingAddress.getCountry() }
                            </cite></small>
