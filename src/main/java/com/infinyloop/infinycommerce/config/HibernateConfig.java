package com.infinyloop.infinycommerce.config;
...
@Configuration
@ComponentScan(basePackages = { "com.infinyloop.infinycommerce.entity" })
@EnableTransactionManagement
public class HibernateConfig {

	private final static String DATABASE_DRIVER = "com.mysql.jdbc.Driver";
	private final static String DATABASE_URL = "jdbc:mysql://localhost:3306/devdb";
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.infinyloop.infinycommerce.entity" });
